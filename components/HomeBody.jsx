...
const HomeBody = () => {
  ...
  return (
    <>
      <div  className="flex min-h-screen items-center justify-center flex-col bg-blue-100 font-sans" id="#smooth-content">
        <Loading />
        <Navbar />
        <Hero />
        <AboutSec />
        <AfterAbout
          text1={"In Assassin's Creed Mirage, you are Basim,"}
          text2={
            "a cunningstreet thief with nightmarish visions seeking answers and justice.Join an ancient organisation and come to understand a new creed – onethat will change Basim’s fate in ways he never could have imagined."
          }
        />
        <CharactersSec />
        <AfterAbout
          text1={"Valley of Memory, a free major update, introduces"}
          text2={
